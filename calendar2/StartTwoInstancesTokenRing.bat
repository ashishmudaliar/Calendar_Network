...
START "runas /user:administrator" cmd /t:04 /K  "cd %~dp0instance1\Service & java -jar BitCalendarService.jar 5555 1" 
...
START "runas /user:administrator" cmd /t:0A /K  "cd %~dp0instance2\Service & java -jar BitCalendarService.jar 8888 1" 
