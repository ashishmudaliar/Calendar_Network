...
START "runas /user:administrator" cmd /t:03 /K  "cd %~dp0instance1 & BitCalendarService.exe 5555 0"
...
START "runas /user:administrator" cmd /t:05 /K  "cd %~dp0instance2 & BitCalendarService.exe 8888 0"
